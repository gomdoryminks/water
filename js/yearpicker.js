...
var methods = {
  ...
  showView: function showView() {
    ...
    //달력을 열었을 경우 보이는 데이터들을 선택된 값이 있는 데이터들로 설정
    if (this.year != undefined) {
        //20220803 수정부분 start
        //this.viewYear = (parseInt(this.year / 12) * 12) + 6;
        //20220803 수정부분 end
        this.renderYear();  
    }
...
var Yearpicker = (function() {
  ...
  Yearpicker.prototype = {
    ...
    setValue: function(setYear) {
      var $this = this.$element;
      var value = this.year;
      
      if (setYear != undefined) {
          //setValue함수를 통해 전달된 값으로 설정
          this.year = parseInt(setYear);
          //20220803 수정부분 start
          //this.viewYear = (parseInt(this.year / 12) * 12) + 6;
          //20220803 수정부분 end
          this.renderYear();
    ...
    place: function() {
      ...
      //document 높이가 잘못 설정되는 경우가 있어서 일단 window로 변경함
